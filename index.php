    ...
    if (is_object($mysqli)) {
        ...
        $error = "";
            ...
            if($_SERVER["REQUEST_METHOD"] == "POST")
                ...
                $sql=sprintf("SELECT idusuario,nombre,nivel FROM usuarios WHERE usuario='$myusername' 
                and pw=(AES_ENCRYPT('%s','%s'))",$mypassword,$mypassword);
                ...
                //seleccion de hoja según nivel
                    switch ($nivel) {
                        case 1:
                            header("location: portaltodo.php");
                            break;
						case 2:
